...
void UART02_IRQHandler(void)
{
    ...
    uint32_t u32IntSrc = ((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->ISR;

     
    if (u32IntSrc & ((1ul << 0)|(1ul << 4))) { 
         
        while (((((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->FSR & (1ul << 14)) == 0) && (bufhead < 64)) {
            uart_rcvbuf[bufhead++] = ((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->RBR;
        }
    }
...
void PutString(void)
{
    ...
    for (i = 0; i < 64; i++) {
        ...
        ((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->THR = response_buff[i];
    }
}
...
void UART_Init()
{
    ...
    ((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->FUN_SEL = (0x0 << 0);
     
    ((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->LCR = (3) | (0x0 << 3) | (0x0 << 2);
     
    ((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->FCR = (0x3 << 4) | (0x3 << 16);
     
    ((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->BAUD = ((0) | (((((22118400UL)) + ((115200)*8)) / (115200) >> 4)-2));
     
    ((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->TOR = (((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->TOR & ~(0xFFul << 0)) | (0x40);
    NVIC_SetPriority(UART02_IRQn, 2);
    NVIC_EnableIRQ(UART02_IRQn);
     
    ((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->IER = ((1ul << 11) | (1ul << 4) | (1ul << 0));
}
