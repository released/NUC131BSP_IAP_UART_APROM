...
__attribute__((zero_init)) int flag_check_ISP_process __attribute__((at( 0x20001FFC)));
...
void IAPSystemReboot_RST(unsigned char addr , unsigned char sel)
{
    ...
    switch(addr) 
    {
        ...
        case (1):
            ...
            __set_PRIMASK(1);    
            FMC_SetVectorPageAddr(0x00003000UL);
            (((FMC_T *) ((( uint32_t)0x50000000) + 0x0C000))->ISPCON &= ~(0x1ul << 1));        
            break;            
    }
...
void EraseAP(unsigned int addr_start, unsigned int addr_end)
{
    ...
    for (; eraseLoop < (addr_start+addr_end); eraseLoop += 0x200) {
#line 168 "..\\ISP_USER.c"
...
#line 253 "..\\ISP_USER.c"
        ...
        EraseAP(0x00003000UL, g_apromSize);
